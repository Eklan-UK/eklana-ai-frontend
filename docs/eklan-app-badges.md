...
|---|------------|------|-------------|
| 1 | First Steps | 👣 | Complete your first ever drill |
...
**Before completion:** You earn this award for completing your first ever drill.

**After completion**

- **Outcome description:** You've earned this award for completing your first drill and officially started your journey toward confident nursing communication.
...
**Before completion:** You earn this award for correctly practicing 50 medication names and explanations.

**After completion**

- **Outcome description:** You've earned this award for correctly practicing 50 medication names and explanations.
...
**Before completion:** You earn this award for completing handover drills.

**After completion**

- **Outcome description:** You've earned this award for completing handover drills.
