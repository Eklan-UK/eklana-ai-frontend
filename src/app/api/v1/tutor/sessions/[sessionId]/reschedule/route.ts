// POST /api/v1/tutor/sessions/[sessionId]/reschedule — move session within same UTC week (assigned tutor only)
...
async function postHandler(
  ...
  await svc.tutorRescheduleSession({
    sessionId: params.sessionId,
    tutorUserId: context.userId,
