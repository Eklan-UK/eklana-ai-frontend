// DEPRECATED — use /api/v1/cron/drill-daily-practice-reminder (daily 18:00 UTC practice blast)
...
export async function GET(req: NextRequest) {
  console.warn(
    '[cron] drill-assigned-reminder is deprecated — use drill-daily-practice-reminder',
  );
