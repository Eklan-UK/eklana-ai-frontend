// GET /api/v1/admin/learners/[learnerId]/key-phrases-analytics
...
import { getLearnerKeyPhrasesAnalytics } from '@/domain/admin/platform-analytics.service';
...
async function handler(
	...
	try {
		...
		const analytics = await getLearnerKeyPhrasesAnalytics(canonicalLearnerId, { from, to });
		...
		logger.error('GET admin/learners/.../key-phrases-analytics', { error: msg });
