...
/**
 * Fetches every learner for the AI Drill Builder by paginating through the admin API.
 ...
 */
export function useAiDrillBuilderLearners(enabled = true) {
  return useQuery({
...
/** @deprecated Use useAiDrillBuilderLearners */
export const useAiUserBuilderLearners = useAiDrillBuilderLearners;
