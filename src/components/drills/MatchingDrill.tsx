...
export default function MatchingDrill({ drill }: MatchingDrillProps) {
  ...
  return (
    <div className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="max-w-md mx-auto px-4 py-6">
        <Card>
          <h2 className="text-xl font-bold text-gray-900 mb-4">Matching Practice</h2>
          <p className="text-gray-600 mb-4">
            This matching drill interface is coming soon. Match words with their definitions or translations.
          </p>
