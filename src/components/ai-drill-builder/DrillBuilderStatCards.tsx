...
export type DrillBuilderStatCardData = {
  totalDrills: number;
...
const CARDS: Array<{
  key: keyof DrillBuilderStatCardData;
  label: string;
  subtitle: string;
...
export function DrillBuilderStatCards({
  stats,
  loading,
}: {
  stats: DrillBuilderStatCardData;
  loading?: boolean;
}) {
  return (
