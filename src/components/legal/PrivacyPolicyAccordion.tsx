...
const link =
  "text-emerald-600 underline underline-offset-2 hover:text-emerald-700 break-all";
  ...
  return (
    <div className="flex flex-col items-start w-full">
      <button
        type="button"
        onClick={onToggle}
        className="flex items-start justify-between w-full p-3 rounded-lg border border-gray-100 text-left gap-2 hover:bg-gray-50 transition-colors"
        aria-expanded={isOpen}
      >
        <span className="text-sm font-semibold text-gray-900 leading-5 flex-1 min-w-0">
          {title}
        </span>
      ...
      {isOpen && (
        <div className="px-2 pt-2 pb-1 w-full text-sm text-gray-700 leading-5 space-y-2">
          {content}
        </div>
      )}
      <div className="w-full border-t border-gray-100 mt-0" />
    </div>
  );
}
...
const sections: Section[] = [
  {
    ...
    content: (
      <>
        ...
        <p>
          <strong className="text-gray-900">Eklan UK Limited</strong>
          <br />
          (&quot;Eklan&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;)
        </p>
      </>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="font-semibold text-gray-900">A. Non-Personal Data</p>
        <p>
        ...
        <p className="font-semibold text-gray-900">B. Personal Information</p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="font-semibold text-gray-900">A. With Your Consent</p>
        <p>When you explicitly agree to share certain data.</p>

        <p className="font-semibold text-gray-900">B. With Service Providers</p>
        <p>
        ...
        <p className="font-semibold text-gray-900">C. Business Transfers</p>
        ...
        <p className="font-semibold text-gray-900">D. Legal Requirements & Safety</p>
        ...
        <p className="font-semibold text-gray-900">E. International Data Transfers</p>
...
export function PrivacyPolicyAccordion() {
  ...
  return (
    <div>
      <div className="text-sm text-gray-700 leading-5 mb-4 space-y-3">
        <p>
