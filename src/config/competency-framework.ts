...
export interface TopicCompetencies {
  topic: string;
  competencies: Competency[];
}

export const COMPETENCY_FRAMEWORK: Record<string, TopicCompetencies> = {
  ...
  patient_follow_up: {
    topic: "Follow-up with Patients and Answering Patient's Questions",
    competencies: [
  ...
  admitting_patient: {
    topic: "Admitting a Patient",
    competencies: [
      { id: 1, name: "Introduces self clearly", description: "States name and role confidently and professionally" },
      { id: 2, name: "Explains role and purpose of interaction", description: "Clearly confirms why they are there and what will happen during admission" },
  ...
  small_talk_patient: {
    topic: "Small Talk with a Patient",
    competencies: [
  ...
  declining_request: {
    topic: "Declining a Request and Professionally Saying No",
    competencies: [
  ...
  small_talk_colleagues: {
    topic: "Small Talk with Colleagues",
    competencies: [
  ...
  providing_updates_doctor: {
    topic: "Providing Updates to a Doctor",
    competencies: [
  ...
  doctor_rounds: {
    topic: "Going on Rounds with Doctors",
    competencies: [
  ...
  answering_family_questions: {
    topic: "Answering Families and Friends' Questions",
    competencies: [
  ...
  phone_colleagues: {
    topic: "Phone Communication with Colleagues",
    competencies: [
  ...
  phone_other_departments: {
    topic: "Phone Communication with Other Departments",
    competencies: [
  ...
  phone_patient_families: {
    topic: "Phone Communication with Patient's Families",
    competencies: [
